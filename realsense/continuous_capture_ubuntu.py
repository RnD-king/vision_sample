...
# python3 ./continuous_capture_ubuntu.py
...
def print_connected_devices():
    ...
    if len(devices) == 0:
        raise RuntimeError(
            "RealSense camera was not detected. On Ubuntu, check USB connection "
            "and librealsense udev rules."
        )
...
def main():
    ...
    print("SPACE: start after 2s countdown / stop, ENTER: save one image, ESC: quit.")
        ...
        while True:
            try:
                ...
                print(
                    ...
                    "another app, and using a USB 3 port."
                )
